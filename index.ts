async function newPeer(
  ...
  return new Promise(async (ok, fail) => {
    pc.onicegatheringstatechange = e => {
      ...
      if (pc.localDescription != null) ok(pc)
      else fail(new Error("pc.localDescription is null"))
    }
...
(window as any).go = async function(remote?: string): Promise<RTCPeerConnection> {
